...
// $email = $_SESSION['email']; // Suponiendo que también tienes el correo guardado en la sesión
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div class="container">
    <h1 class="welcome-message">Bienvenido al sistema de clientes, <?php echo htmlspecialchars($_SESSION['usuario']); ?>.</h1>
